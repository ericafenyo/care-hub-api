...
-- Insert credentials
insert into senior_hub.credentials (id, created_at, password, updated_at, user_id)
...
-- Insert users
insert into senior_hub.users (id, birth_date, created_at, email, first_name, last_name, photo, updated_at, address_id)
...
-- Insert addresses
insert into senior_hub.addresses (id, created_at, postal_code, street, city_id, country_id)
...
-- Insert cities
insert into senior_hub.cities (id, created_at, name)
...
-- Insert countries
insert into senior_hub.countries (id, created_at, name)
